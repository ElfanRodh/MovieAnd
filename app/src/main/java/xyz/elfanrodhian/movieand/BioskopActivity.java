...
import xyz.elfanrodhian.movieand.lokasi.GetNearbyPlacesData;
...
public class BioskopActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    FloatingActionButton btnBioskop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBioskop = (FloatingActionButton) findViewById(R.id.btnFind);
        btnBioskop.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void bioskop() {
        String Bioskop = "bioskop";
        Log.d("onClick", "Button is Clicked");
        mMap.clear();
        String url = getUrl(latitude, longitude, Bioskop);
        ...
        Toast.makeText(this,"Bioskop Terdekat", Toast.LENGTH_LONG).show();
    }
